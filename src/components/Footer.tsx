...
export default function Footer() {
  return (
    <footer id="contacts" className="relative w-full bg-[#7BA341] text-white pt-8 pb-12 z-20">
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-12 gap-8 md:gap-10 text-center md:text-left mt-2">
        ...
        <div className="md:col-span-4 flex flex-col items-center md:items-start mb-6 md:mb-0">
          <h2 className="text-5xl font-black font-serif text-white tracking-tighter mb-4 md:mb-6 drop-shadow-sm">AliRo</h2>
        ...
        <div className="md:col-span-8 flex flex-row justify-between md:grid md:grid-cols-2 gap-2 md:gap-10 text-left w-full px-2">
          ...
          <div className="flex flex-col items-start w-[48%] md:w-full">
            ...
            <p className="text-white/90 mb-3 text-xs md:text-xl flex items-center gap-2 font-semibold">
              <span className="text-base md:text-2xl">📍</span> вул. Келецька, 84, Вінниця
            </p>
            <p className="text-white/90 mb-4 md:mb-6 text-xs md:text-xl flex items-center gap-2 font-semibold">
              <span className="text-base md:text-2xl">📞</span> 067 900 9315
            </p>
            <p className="text-white font-black text-[10px] md:text-lg bg-white/40 px-2 py-2 md:px-5 md:py-3 rounded-lg md:rounded-xl inline-block shadow-sm">
              Пн–Нд: 10:00–21:00
            </p>
          </div>
          ...
          <div className="flex flex-col items-start w-[48%] md:w-full">
            ...
            <div className="flex flex-col gap-4 md:gap-5 w-full">
              ...
              <a href="https://instagram.com/aliro_vn" target="_blank" rel="noreferrer" className="group flex items-center gap-2 md:gap-4 hover:-translate-y-1 transition-transform text-left">
                ...
                <span className="font-black text-[11px] sm:text-xs md:text-xl text-white">@aliro_vn</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="w-full text-center text-white/40 text-sm mt-16 md:mt-24 pt-8 border-t border-[#0B0C10]/10 max-w-7xl mx-auto px-6 font-semibold">
