...
export default function Footer() {
  return (
    <footer id="contacts" className="relative w-full bg-[#FFB800] text-[#0B0C10] pt-8 pb-12 z-20">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-10 text-center md:text-left mt-2">
        ...
        {/* Contacts */}
        <div className="md:col-span-4 flex flex-col items-center md:items-start">
          <h3 className="text-2xl font-bold mb-4 md:mb-6 font-serif">Контакти</h3>
          <p className="text-[#0B0C10]/90 mb-3 text-lg md:text-xl flex items-center gap-3 font-semibold">
            <span className="text-2xl">📍</span> вул. Наукова, 9а
          </p>
          <p className="text-[#0B0C10]/90 mb-4 md:mb-6 text-lg md:text-xl flex items-center gap-3 font-semibold">
            <span className="text-2xl">📞</span> 096 159 23 77
          </p>
          <p className="text-[#0B0C10] font-black text-sm md:text-lg bg-white/40 px-5 py-3 rounded-xl inline-block shadow-sm">
        ...
        {/* Socials */}
        <div className="md:col-span-4 flex flex-col items-center md:items-start">
          <h3 className="text-2xl font-bold mb-4 md:mb-6 font-serif">Слідкуй за нами</h3>
          
          <div className="flex flex-col gap-5">
            {/* Instagram */}
            <a href="https://instagram.com/denis__zalizko" target="_blank" rel="noreferrer" className="group flex items-center gap-4 hover:-translate-y-1 transition-transform text-left">
              <div className="w-14 h-14 bg-[#0B0C10] text-white rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow shrink-0">
            ...
            {/* TikTok */}
            <a href="https://tiktok.com/@rubinchik1m" target="_blank" rel="noreferrer" className="group flex items-center gap-4 hover:-translate-y-1 transition-transform text-left">
              <div className="w-14 h-14 bg-[#0B0C10] text-white rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow shrink-0">
